      ...
      <div className="card w-100 p-0 background-white borderblack">
        <div className="row g-0">
          ...
          <div className="col-8 col-md-7 p-2 d-flex flex-column h-100 ">
            <div>
              <a href="#bookbtn" style={{ textDecoration: "none" }}>
                <h4
                  className="txt-dark booktitle"
                  onClick={() => {
                    setdefaultvalue(props);
                    prop.togglenewbookadding();
                  }}
                >
                  {props.bookname}
                </h4>
              ...
              <div>
                <p className="txt-dark text-start descriptiontxt m-1">
                  {props.description}
                </p>
                <p className="txt-dark text-start  tagstxt m-0">
                  Tags: <Tagsrender tags={props.tags} />
                </p>
              </div>
            </div>

            <div
              className="h-100 justify-content-center text-start"
              style={{ display: "flex", flexDirection: "column" }}
            >
              <p
                className="txt-dark text-start text-truncate m-0"
