...
function ImageSelect(props) {
  ...
  return (
    <div
      className="col-lg-5 col-md-9 p-0 background-light"
      style={{
    ...
    >
      <div
        ...
        style={{ aspectRatio: "0.78", borderRadius: "15px 0px 15px 15px " }}
      >
        <img
      ...
      <div className="mt-1">
        <span className="text-center w-100  h5 txt-dark" id="basic-addon3">
          Book cover url:
        </span>
      </div>
      <div className="input-group m-1 p-2">
        ...
        />
        <button
          className="btn btn-outline-secondary background-dark"
          type="button"
          onClick={updateurl}
        >
          &#10004;
