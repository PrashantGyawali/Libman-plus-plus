...
{ 
    ...
    return(
    <div className="col-lg-5 col-md-9 p-0" style={{border:"3px solid black",   borderRadius: "15px 0px 0px 15px ",   aspectRatio: "0.75"}}>
    ...
    <input type="text" className="form-control" id="url" name='url' aria-describedby="basic-addon3" onChange={(e)=>updateform(e)} />
